---
subject: runx-todo-done
description: Archived completed RunX task specifications and acceptance records.
parent: runx-todo
children: []
files:
  manifest-v2-composition.md: Completed manifest v2 composition specification and public acceptance record for issue 26.
  release-runx-0.10.0.md: Completed live audit and canonical 0.10.0 release record for merged pull requests 29 and 31.
  release-runx-0.10.1.md: Completed live post-0.10.0 audit and canonical patch release record for every remaining RunX change.
  release-runx-0.11.0.md: Completed minor release record with Mirror, workflow, asset, checksum, npm, and native smoke evidence.
...
documents:
  ...
  release-runx-0.10.0.md: Completed task specification and acceptance evidence for the Mirror-managed RunX 0.10.0 release.
  release-runx-0.10.1.md: Completed task specification and acceptance evidence for the Mirror-managed RunX 0.10.1 release.
  release-runx-0.11.0.md: Completed task specification and acceptance evidence for the Mirror-managed RunX 0.11.0 release.
...
Completed task specifications remain here as permanent project history.
