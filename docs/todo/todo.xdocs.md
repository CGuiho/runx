...
files:
  ...
  release-runx-0.11.0.md: Records the minor-release decision and acceptance contract for the RunX 0.11.0 publication.
documents:
  ...
  release-runx-0.11.0.md: Testing task specification for the Mirror-managed RunX 0.11.0 release.
tags:
  - todo
keywords:
  - runx
