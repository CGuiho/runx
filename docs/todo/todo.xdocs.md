...
files:
  ...
  manifest-v2-composition.md: Defines GitHub issue 26 recursive commands, namespaces, parent-child catalogs, migration, and public acceptance.
documents:
  ...
  manifest-v2-composition.md: Active task specification for RunX manifest v2 composition.
tags:
  - todo
keywords:
  - runx
