...
files:
  ...
  cli.ts: Defines the Citty command tree and reports manifest, agent, and native self-management outcomes.
...
agents install` remains available without Bun at runtime.
