...
documents:
  ...
  DOCS.md: Complete production CLI, manifest, execution confirmation, lifecycle, agent, upgrade, installer, and 11-artifact reference.
  LICENSE.md: MIT license.
  README.md: Public installation with concise verified bootstrap commands and cross-shell PATH guidance, plus manifest-v2, stable UID, numeric-index, safe confirmation, command, and Go release overviews.
