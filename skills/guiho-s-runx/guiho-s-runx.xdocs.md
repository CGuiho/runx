...
description: Agent workflow for safe RunX catalog work, stable UID and interactive numeric-index selection, explicit confirmation, bare-command bootstrap, automatic resource maintenance, and verified native upgrade/list/recovery operations.
parent: runx-skills
children: []
files:
  SKILL.md: RFC-aligned RunX catalog inspection, stable and numeric selector guidance, safe-default prompt and explicit confirmation rules, execution safety, YAML precedence, agent, and upgrade guidance.
documents:
