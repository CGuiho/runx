...
files:
  ...
  install_ps1_test.go: Verifies script contracts and syntax, then runs native Windows PowerShell clean install, injected rollback, reinstall, a different-version whole-release upgrade, and same-version upgrade idempotence.
